...
The official Node.js client for [Orca Scan](https://orcascan.com), lets you manage **sheets**, **rows**, **users**, **hooks** and **history** via the [Orca Scan API](https://orcascan.com/guides/barcode-scanner-api-f09a21c3).
